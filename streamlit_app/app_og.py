...
history_url = f"http://127.0.0.1:8000/conversation/{user_id}/{character_id}/"
save_url = f"http://127.0.0.1:8000/conversation/{user_id}/{character_id}/save/"
...
if st.button("Send"):
    if user_input:
        # Mock chatbot response (replace this with actual API call)
